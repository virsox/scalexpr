...
trait BooleanMethods { this: Expression[Boolean] =>
  ...
  /**
    ...
    */
  def &&(rhs: Expression[Boolean]): LogicalExpression = LogicalExpression(this, And, rhs)
  ...
  /**
    ...
    */
  def ||(rhs: Expression[Boolean]): LogicalExpression = LogicalExpression(this, Or, rhs)
}
...
trait OrderingMethods[T] { this: Expression[T] =>
  ...
  /** *
    ...
    */
  def ==(rhs: Expression[T]): RelationalExpression[T] = RelationalExpression(this, Equals, rhs)
  ...
  /** *
    ...
    */
  def !=(rhs: Expression[T]): RelationalExpression[T] = RelationalExpression(this, NotEquals, rhs)
  ...
  /** *
    ...
    */
  def <(rhs: Expression[T]): RelationalExpression[T] = RelationalExpression(this, LessThan, rhs)
  ...
  /** *
    ...
    */
  def <=(rhs: Expression[T]): RelationalExpression[T] = RelationalExpression(this, LessEqualsThan, rhs)
  ...
  /** *
    ...
    */
  def >(rhs: Expression[T]): RelationalExpression[T] = RelationalExpression(this, GreaterThan, rhs)
  ...
  /** *
    ...
    */
  def >=(rhs: Expression[T]): RelationalExpression[T] = RelationalExpression(this, GreaterEqualsThan, rhs)
}
...
abstract class AbstractExpr[T: TypeTag] extends Expression[T] {
  override val typeTagEvidence: universe.TypeTag[T] = implicitly[TypeTag[T]]
}
...
abstract class OrderingExpr[T: Ordering: TypeTag] extends AbstractExpr[T] with OrderingMethods[T] {
  val orderingEvidence: Ordering[T] = implicitly[Ordering[T]]
}
